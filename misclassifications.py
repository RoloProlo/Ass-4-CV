...
if __name__ == "__main__":
    ...
    false_negatives_cats = 0
    false_negatives_dogs = 0
    ...
    with torch.no_grad():
        for idx, (images, bboxes, labels, _) in enumerate(val_loader):
            ...
            if gt_labels_img and not detections:
                ...
                if true_label == 0:
                    false_negatives_cats += 1
                elif true_label == 1:
                    false_negatives_dogs += 1
    ...
    # Print results
    print(f"False Negatives - Cats: {false_negatives_cats}")
    print(f"False Negatives - Dogs: {false_negatives_dogs}")
